...
//    newRequestSpecification.filters(requestLoggingFilter, responseLoggingFilter);
        ...
        System.out.println("Request coordinates: [" + this.baseQueryParameters.get("waypoint0") + " " + this.baseQueryParameters.get("waypoint1") + "] Response status code: " + response.getStatusLine());
